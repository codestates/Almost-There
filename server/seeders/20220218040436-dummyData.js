...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const group1 = await queryInterface.bulkInsert('_groups', [{
      name: '김코딩 모임',
    ...
    const group2 = await queryInterface.bulkInsert('_groups', [{
      name: '박해커 모임',
      time: new Date(Date.now()),
    ...
    const group3 = await queryInterface.bulkInsert('_groups', [{
      name: '전상인 모임',
      time: new Date(Date.now()),
